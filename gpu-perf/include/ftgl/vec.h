...
*
*  @file:    node_manage.h
*  @brif:    A template class for creating, managing and operating on a 2-element 
*            2-element vector of any type you like (intended for built-in types, 
*            but as long as it supports the basic arithmetic and assignment 
*            operators, any type should work).
*
******************************************************************************/
...
template<typename T>
const matrix::tvec2<T> operator*(const T t, const matrix::tvec2<T>& v)
{
    return v * t;
}

template<typename T>
const matrix::tvec3<T> operator*(const T t, const matrix::tvec3<T>& v)
{
    return v * t;
}

template<typename T>
const matrix::tvec4<T> operator*(const T t, const matrix::tvec4<T>& v)
{
    return v * t;
}
