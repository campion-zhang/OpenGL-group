/*
    ...
    OpenGL ES loader generated by glad 0.1.36 on Fri Oct 21 01:24:32 2022.
...
int gladLoadGLES2Loader(GLADloadproc load) {
    ...
    if(glGetString == NULL) {
        printf("glad : gladLoadGLES2Loader failed, glGetString is null\n");
        return 0;
    }
    if(glGetString(GL_VERSION) == NULL) {
        printf("glad : gladLoadGLES2Loader failed, GL_VERSION is null\n");
        return 0;
    }
	find_coreGLES2();
    ...
    if (!find_extensionsGLES2()) {
        printf("glad : gladLoadGLES2Loader failed, find_extensionsGLES2 failed\n");
        return 0;
    }
